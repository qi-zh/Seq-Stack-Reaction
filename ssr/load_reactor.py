...
class MolecularTransformer:
    ...
    def react(self, reactant_list, *, batch_size=64) -> list:
        ...
        _, product_list = self._model.translate(
            src=reactant_token_list, src_dir="", batch_size=batch_size, attn_debug=False
        )
...
def load_reactor(max_length=80, *, device_id=-1, model_path="") -> MolecularTransformer:
    """
    ...
    return MolecularTransformer(translator)
